...
use agent_transport_protocol_schema::v1::{
...
///
/// This uses the JSON-RPC envelope types from `agent-transport-protocol-schema`
...
///
/// ```
/// # use agent_transport_protocol::{Agent, Client, ConnectTo};
/// # use agent_transport_protocol::schema::v1::{AgentCapabilities, InitializeRequest, InitializeResponse};
/// # use agent_transport_protocol_test::StatusUpdate;
/// # async fn example(transport: impl ConnectTo<Agent>) -> Result<(), agent_transport_protocol::Error> {
/// Agent.builder()
...
///         )
///     }, agent_transport_protocol::on_receive_request!())
///     .on_receive_notification(async |notif: StatusUpdate, cx| {
///         // Process notification
///         Ok(())
///     }, agent_transport_protocol::on_receive_notification!())
...
///
/// ```
/// # use agent_transport_protocol::{Client, Agent, ConnectTo};
/// # use agent_transport_protocol_test::{expensive_operation, ProcessComplete};
/// # async fn example(transport: impl ConnectTo<Client>) -> Result<(), agent_transport_protocol::Error> {
...
///
/// ```no_run
/// # use agent_transport_protocol_test::*;
/// # use agent_transport_protocol::schema::v1::{InitializeRequest, InitializeResponse, SessionNotification};
/// # async fn example() -> Result<(), agent_transport_protocol::Error> {
...
///         Ok(())
///     }, agent_transport_protocol::on_receive_notification!())
/// # .connect_to(agent_transport_protocol_test::MockTransport).await?;
/// # Ok(())
/// # }
/// ```
///
...
/// ```no_run
/// # use agent_transport_protocol_test::*;
/// # use agent_transport_protocol::{JsonRpcRequest, JsonRpcMessage, UntypedMessage};
/// # use agent_transport_protocol::schema::v1::{InitializeRequest, InitializeResponse, PromptRequest, PromptResponse};
/// # async fn example() -> Result<(), agent_transport_protocol::Error> {
/// # let connection = mock_connection();
...
/// #     fn to_untyped_message(&self) -> Result<UntypedMessage, agent_transport_protocol::Error> { todo!() }
/// #     fn parse_message(_method: &str, _params: &impl serde::Serialize) -> Result<Self, agent_transport_protocol::Error> { Err(agent_transport_protocol::Error::method_not_found()) }
/// # }
...
/// ```no_run
/// # use agent_transport_protocol_test::*;
/// # use agent_transport_protocol::Dispatch;
/// # use agent_transport_protocol::schema::v1::{InitializeRequest, InitializeResponse, SessionNotification};
/// # async fn example() -> Result<(), agent_transport_protocol::Error> {
/// # let connection = mock_connection();
...
///         }
///     }
/// }, agent_transport_protocol::on_receive_dispatch!())
/// # .connect_to(agent_transport_protocol_test::MockTransport).await?;
/// # Ok(())
/// # }
/// ```
...
/// ```no_run
/// # use agent_transport_protocol_test::*;
/// # use agent_transport_protocol::{Dispatch, UntypedMessage};
/// # use agent_transport_protocol::schema::v1::{InitializeRequest, InitializeResponse, PromptRequest, PromptResponse};
/// # async fn example() -> Result<(), agent_transport_protocol::Error> {
/// # let connection = mock_connection();
/// connection
...
///         msg.respond_with_error(agent_transport_protocol::util::internal_error("unknown method"), cx)
///     }, agent_transport_protocol::on_receive_dispatch!())
/// # .connect_to(agent_transport_protocol_test::MockTransport).await?;
/// # Ok(())
/// # }
...
/// ```no_run
/// # use agent_transport_protocol_test::*;
/// # use agent_transport_protocol::schema::v1::InitializeRequest;
/// # async fn example() -> Result<(), agent_transport_protocol::Error> {
/// # let connection = mock_connection();
/// connection
///     .on_receive_request(async |req: MyRequest, responder, cx| {
...
///
/// ```no_run
/// # use agent_transport_protocol::UntypedRole;
/// # use agent_transport_protocol::{Builder};
/// # use agent_transport_protocol::Stdio;
/// # use agent_transport_protocol::schema::v1::{InitializeRequest, InitializeResponse, PromptRequest, PromptResponse, SessionNotification};
/// # async fn example() -> Result<(), agent_transport_protocol::Error> {
...
> Builder<Host, Handler, Runner>
{
    ...
    /// # use agent_transport_protocol::UntypedRole;
    /// # use agent_transport_protocol::{Builder};
    /// # use agent_transport_protocol::schema::v1::{PromptRequest, PromptResponse, SessionNotification};
    /// # fn example<R: agent_transport_protocol::Role>(connection: Builder<R, impl agent_transport_protocol::HandleMessageAs<R>>) {
    ...
    ///
    /// ```ignore
    /// use agent_transport_protocol::Agent;
    /// use agent_transport_protocol::schema::v1::InitializeRequest;
    ///
    ...
    /// # use agent_transport_protocol::UntypedRole;
    /// # use agent_transport_protocol::{Builder};
    /// # use agent_transport_protocol::ByteStreams;
    /// # use agent_transport_protocol::schema::v1::InitializeRequest;
    /// # use agent_transport_protocol::Stdio;
    /// # use agent_transport_protocol_test::*;
    /// # async fn example() -> Result<(), agent_transport_protocol::Error> {
...
impl<Counterpart: Role> ConnectionTo<Counterpart> {
    ...
    /// ```
    /// # use agent_transport_protocol::UntypedRole;
    /// # use agent_transport_protocol::{Builder, ConnectionTo};
    /// # use agent_transport_protocol_test::*;
    /// # async fn example(cx: ConnectionTo<UntypedRole>) -> Result<(), agent_transport_protocol::Error> {
    ...
    /// ```compile_fail
    /// # use agent_transport_protocol_test::*;
    /// # async fn example(cx: agent_transport_protocol::ConnectionTo<agent_transport_protocol::UntypedRole>) -> Result<(), agent_transport_protocol::Error> {
    ...
    /// ```no_run
    /// # use agent_transport_protocol_test::*;
    /// # async fn example(cx: agent_transport_protocol::ConnectionTo<agent_transport_protocol::Agent>) -> Result<(), agent_transport_protocol::Error> {
    /// cx.send_notification(StatusUpdate {
...
///
/// ```ignore
/// use agent_transport_protocol::JsonRpcResponse;
...
///
/// ```ignore
/// use agent_transport_protocol::JsonRpcNotification;
/// use serde::{Serialize, Deserialize};
///
...
///
/// ```ignore
/// use agent_transport_protocol::{JsonRpcRequest, JsonRpcResponse};
/// use serde::{Serialize, Deserialize};
///
...
impl Dispatch {
    ...
    /// Extract the agent transport session-id from this message (if any).
    ///
...
/// which should keep running on the peer, should use [`detach`](Self::detach)
/// instead.
...
impl<T> SentRequest<T> {
    ...
    ///
    /// ```
    /// # use agent_transport_protocol::{ConnectionTo, Error, Responder, UntypedRole};
    /// # use agent_transport_protocol_test::{MyRequest, MyResponse};
...
impl<T: JsonRpcResponse> SentRequest<T> {
    ...
    ///             } else {
    ///                 responder.respond_with_error(agent_transport_protocol::util::internal_error("validation failed"))
    ///             }
    ///         })?;
    ///
    ///     Ok(())
...
/// agent_transport_protocol::UntypedRole.builder()
///     .name("my-client")
...
/// ```no_run
/// # use agent_transport_protocol::UntypedRole;
/// # use agent_transport_protocol::{Channel, Builder};
/// # async fn example() -> Result<(), agent_transport_protocol::Error> {
