//! The roles in agent transport: clients, agents, proxies, and conductors.
//!
//! The agent transport protocol defines how AI agents communicate with the
...
//!
//! The [`agent-transport-protocol-conductor`] crate provides a conductor implementation. Most users
