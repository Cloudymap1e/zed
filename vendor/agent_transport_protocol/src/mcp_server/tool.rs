...
///
/// ```rust,ignore
/// use agent_transport_protocol::mcp_server::{McpConnectionTo, McpTool};
/// use schemars::JsonSchema;
...
/// struct EchoTool;
///
/// impl<R: agent_transport_protocol::role::Role> McpTool<R> for EchoTool {
...
///     ) -> Result<EchoOutput, agent_transport_protocol::Error> {
///         Ok(EchoOutput {
