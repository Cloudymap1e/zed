//! Content blocks for representing various types of information in the agent transport protocol.
//!
...
//! allowing seamless integration between agent transport and MCP-based tools.
//!
//! See: [Content](https://agent-transport-protocol/protocol/content)
...
/// Content blocks represent displayable information in the agent transport protocol.
///
...
///
/// See protocol docs: [Content](https://agent-transport-protocol/protocol/content)
