//! agent transport protocol version 2 draft types.
//!
...
//! time.
//!
//! [`unstable`]: https://docs.rs/crate/agent-transport-protocol-schema/latest/features
...
///
/// See protocol docs: [Session ID](https://agent-transport-protocol/protocol/session-setup#session-id)
