//! Explicit conversion helpers for experimenting with agent transport v2 while SDKs still speak v1.
//!
...
impl IntoV1 for super::ConnectMcpRequest {
    ...
    fn into_v1(self) -> Result<Self::Output> {
        ...
        Ok(crate::v1::ConnectMcpRequest {
            agent_transport_id: agent_transport_id.into_v1()?,
            meta: meta.into_v1()?,
        })
    }
}
...
impl IntoV2 for crate::v1::ConnectMcpRequest {
    ...
    fn into_v2(self) -> Result<Self::Output> {
        ...
        Ok(super::ConnectMcpRequest {
            agent_transport_id: agent_transport_id.into_v2()?,
            meta: meta.into_v2()?,
        })
    }
}
...
impl IntoV1 for super::McpServer {
    ...
    fn into_v1(self) -> Result<Self::Output> {
        Ok(match self {
            ...
            #[cfg(feature = "unstable_mcp_over_agent_transport")]
            Self::AgentTransport(value) => crate::v1::McpServer::AgentTransport(value.into_v1()?),
...
impl IntoV2 for crate::v1::McpServer {
    ...
    fn into_v2(self) -> Result<Self::Output> {
        Ok(match self {
            ...
            #[cfg(feature = "unstable_mcp_over_agent_transport")]
            Self::AgentTransport(value) => super::McpServer::AgentTransport(value.into_v2()?),
...
#[cfg(feature = "unstable_mcp_over_agent_transport")]
impl IntoV1 for super::McpServerAgentTransportId {
    type Output = crate::v1::McpServerAgentTransportId;

    fn into_v1(self) -> Result<Self::Output> {
        Ok(crate::v1::McpServerAgentTransportId(self.0.into_v1()?))
    }
}

#[cfg(feature = "unstable_mcp_over_agent_transport")]
impl IntoV2 for crate::v1::McpServerAgentTransportId {
    type Output = super::McpServerAgentTransportId;

    fn into_v2(self) -> Result<Self::Output> {
        Ok(super::McpServerAgentTransportId(self.0.into_v2()?))
    }
}
...
#[cfg(feature = "unstable_mcp_over_agent_transport")]
impl IntoV1 for super::McpServerAgentTransport {
    type Output = crate::v1::McpServerAgentTransport;

    fn into_v1(self) -> Result<Self::Output> {
        let Self { name, id, meta } = self;
        Ok(crate::v1::McpServerAgentTransport {
            name: name.into_v1()?,
            id: id.into_v1()?,
            meta: meta.into_v1()?,
        })
...
#[cfg(feature = "unstable_mcp_over_agent_transport")]
impl IntoV2 for crate::v1::McpServerAgentTransport {
    type Output = super::McpServerAgentTransport;

    fn into_v2(self) -> Result<Self::Output> {
        let Self { name, id, meta } = self;
        Ok(super::McpServerAgentTransport {
            name: name.into_v2()?,
            id: id.into_v2()?,
            meta: meta.into_v2()?,
        })
...
impl IntoV1 for super::McpCapabilities {
    ...
    fn into_v1(self) -> Result<Self::Output> {
        ...
        Ok(crate::v1::McpCapabilities {
            ...
            sse: false,
            #[cfg(feature = "unstable_mcp_over_agent_transport")]
            agent_transport: agent_transport.is_some(),
            meta: meta.into_v1()?,
        })
    }
}
...
impl IntoV2 for crate::v1::McpCapabilities {
    ...
    fn into_v2(self) -> Result<Self::Output> {
        ...
        Ok(super::McpCapabilities {
            ...
            #[cfg(feature = "unstable_mcp_over_agent_transport")]
            agent_transport: agent_transport.then(super::McpAgentTransportCapabilities::new),
            meta: meta.into_v2()?,
        })
    }
}
...
mod tests {
    ...
    #[cfg(feature = "unstable_mcp_over_agent_transport")]
    #[test]
    fn v1_mcp_agent_transport_capability_bool_converts_to_v2_object() {
        let v1_capabilities = v1::McpCapabilities::new().agent_transport(true);

        let v2_capabilities: v2::McpCapabilities =
            v1_to_v2(v1_capabilities).expect("v1 -> v2 conversion");
        let v2_json = serde_json::to_value(&v2_capabilities).expect("v2 serialize");
        assert_eq!(
            v2_json.pointer("/agent_transport"),
            Some(&serde_json::json!({}))
        );

        let v1_after: v1::McpCapabilities = v2_to_v1(v2_capabilities).expect("v2 -> v1 conversion");
        assert!(v1_after.agent_transport);
    }
