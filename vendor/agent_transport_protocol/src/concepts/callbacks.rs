...
//!
//! So far we've seen how to *send* messages. But agent transport is bidirectional - the
...
//! ```
//! # use agent_transport_protocol::{Client, Agent, ConnectTo};
//! # use agent_transport_protocol_test::{ValidateRequest, ValidateResponse, ExecuteRequest, ExecuteResponse};
//! # async fn example(transport: impl ConnectTo<Client>) -> Result<(), agent_transport_protocol::Error> {
//! Client.builder()
//!     .on_receive_request(async |req: ValidateRequest, responder, cx| {
