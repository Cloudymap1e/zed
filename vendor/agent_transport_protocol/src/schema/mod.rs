//! agent transport protocol schema types and message implementations.
//!
//! This module contains all the types from the agent transport protocol schema,
...
/// Agent transport v1 schema types.
pub mod v1 {
    pub use agent_transport_protocol_schema::v1::*;
}

/// Agent transport v2 draft schema types.
#[cfg(feature = "unstable_protocol_v2")]
pub mod v2 {
    pub use agent_transport_protocol_schema::v2::*;
}

pub use agent_transport_protocol_schema::{
