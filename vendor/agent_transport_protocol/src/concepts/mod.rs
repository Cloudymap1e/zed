...
//! to work effectively with the agent-transport-protocol SDK. Read these in order for a progressive
//! introduction, or jump to specific topics as needed.
//!
//! # Table of Contents
//!
//! 1. [Agent transport basics][`crate::concepts::agent_transport_basics`] - The roles in the protocol: clients,
...
pub mod agent_transport_basics;
pub mod callbacks;
