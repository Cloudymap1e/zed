...
//!
//! Roles represent the logical identity of an endpoint in an agent transport connection.
...
/// Roles for the agent transport protocol.
pub mod agent_transport;

/// Roles for the MCP protocol.
pub mod mcp;

/// The role that an endpoint plays in an agent transport connection.
///
/// Roles are the fundamental building blocks of agent transport's type system:
/// - [`agent_transport::Client`] connects to [`agent_transport::Agent`]
/// - [`agent_transport::Agent`] connects to [`agent_transport::Client`]
/// - [`agent_transport::Proxy`] connects to [`agent_transport::Conductor`]
/// - [`agent_transport::Conductor`] connects to [`agent_transport::Proxy`]
///
...
///
/// Most roles only communicate with their counterpart, but some (like [`agent_transport::Proxy`])
