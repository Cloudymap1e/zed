...
including [External Agents](./external-agents.md), [Edit Prediction](./edit-prediction.md),
...
| [External Agents](./external-agents.md)                      | The External Agent and its configured providers   | The External Agent handles model requests under its own terms. Tool and MCP behavior depends on agent and External Agent configuration.                                                                                                        | [External Agents](./external-agents.md)                                                           |
