//! Capability management for the `_meta.symposium` object in agent transport messages.
//!
...
//!
//! ```rust,no_run
//! use agent_transport_protocol::{MetaCapability, MetaCapabilityExt};
//! # use agent_transport_protocol::schema::v1::InitializeResponse;
...
pub trait MetaCapability {
    /// The key name in the `_meta.symposium` object (e.g., "proxy", "mcp_agent_transport")
