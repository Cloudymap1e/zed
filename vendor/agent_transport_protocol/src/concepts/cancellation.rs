...
//!
//! The SDK exposes the agent transport `$/cancel_request` notification behind the
...
//!
//! ```
//! # use agent_transport_protocol::{ConnectionTo, Error, UntypedRole};
...
//! ```
//! # use agent_transport_protocol::{ConnectionTo, Error, UntypedRole};
//! use agent_transport_protocol::schema::v1::CancelRequestNotification;
//!
//! # fn example() {
