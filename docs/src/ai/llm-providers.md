...
Use this page to choose which models power Zed AI features and
...
the difference between External Agents and Terminal Threads.

## Edit Prediction {#edit-prediction}

[Edit Prediction](./edit-prediction.md) has its own provider setup under `edit_predictions`. LLM providers on this page apply to model-backed Zed AI features such as Inline Assistant, Git commit generation, and thread summaries.
