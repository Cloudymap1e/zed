...
//!
//! ```
//! # use agent_transport_protocol::{Proxy, Conductor, ConnectTo};
//! # async fn example(transport: impl ConnectTo<Proxy>) -> Result<(), agent_transport_protocol::Error> {
//! Proxy.builder()
...
//!
//! ```
//! # use agent_transport_protocol::{Proxy, Client, Agent, Conductor, ConnectTo};
//! # use agent_transport_protocol_test::ProcessRequest;
//! # async fn example(transport: impl ConnectTo<Proxy>) -> Result<(), agent_transport_protocol::Error> {
//! Proxy.builder()
...
//! ```ignore
//! # use agent_transport_protocol::{Proxy, Conductor, ConnectTo};
//! # use agent_transport_protocol::mcp_server::McpServer;
//! # use agent_transport_protocol_rmcp::McpServerExt;
//! # async fn example(transport: impl ConnectTo<Proxy>) -> Result<(), agent_transport_protocol::Error> {
...
//!
//! ```ignore
//! # use agent_transport_protocol::{Proxy, Client, Conductor, ConnectTo};
//! # use agent_transport_protocol::schema::v1::NewSessionRequest;
//! # use agent_transport_protocol::mcp_server::McpServer;
//! # use agent_transport_protocol_rmcp::McpServerExt;
//! # async fn example(transport: impl ConnectTo<Proxy>) -> Result<(), agent_transport_protocol::Error> {
//! Proxy.builder()
...
//!
//! The [`agent-transport-protocol-conductor`] crate provides a conductor binary. You configure
