//! Error handling patterns in agent-transport-protocol.
//!
//! This chapter explains how errors work in agent-transport-protocol callbacks and the difference
//! between *protocol errors* (sent to the peer) and *connection errors* (which
//! shut down the connection).
//!
//! # Callback Return Types
//!
//! Almost all agent-transport-protocol callbacks return `Result<_, crate::Error>`. What happens
...
//! # use agent_transport_protocol_test::{ValidateRequest, ValidateResponse};
...
//!             responder.respond_with_error(agent_transport_protocol::Error::invalid_params())?;
//!             return Ok(());
//!         }
//!
...
//! cx.send_error_notification(agent_transport_protocol::Error::internal_error()
...
//! you need to convert them to `agent_transport_protocol::Error`. The
//! [`Error::into_internal_error`][crate::Error::into_internal_error] method
//! provides a convenient way to do this:
//!
//! ```
//! use agent_transport_protocol::Error;
//!
//! # fn example() -> Result<(), agent_transport_protocol::Error> {
//! # let data = "hello";
//! # let path = "/tmp/test.txt";
//! // Convert any error type to agent_transport_protocol::Error
...
//!
//! ```
//! let error = agent_transport_protocol::Error::invalid_params()
