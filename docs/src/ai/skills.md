...
Zed Skills apply where an agent integration supports Zed-managed skills. External Agents and Terminal Threads may have their own native skills, prompts, or instruction systems. Configure those in the External Agent or CLI.
