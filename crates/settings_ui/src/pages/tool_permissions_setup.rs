...
const SETTINGS_DISCLAIMER: &str = "Note: custom tool permissions apply to Zed-managed tool calls and don’t extend to external agents connected through the External Agent protocol.";
