...
//! a client that interacts with AI coding agents via the agent transport protocol (agent transport).
...
///
/// See protocol docs: [Agent Reports Output](https://agent-transport-protocol/protocol/prompt-turn#3-agent-reports-output)
...
pub enum SessionUpdate {
    ...
    /// See protocol docs: [Agent Plan](https://agent-transport-protocol/protocol/agent-plan)
    Plan(Plan),
    /// **UNSTABLE**
    ///
...
///
/// See protocol docs: [Requesting Permission](https://agent-transport-protocol/protocol/tool-calls#requesting-permission)
#[skip_serializing_none]
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema, PartialEq)]
...
///
/// See protocol docs: [Client Capabilities](https://agent-transport-protocol/protocol/initialization#client-capabilities)
#[serde_as]
#[skip_serializing_none]
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
...
///
/// See protocol docs: [FileSystem](https://agent-transport-protocol/protocol/initialization#filesystem)
#[skip_serializing_none]
#[derive(Default, Debug, Clone, Serialize, Deserialize, JsonSchema, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
#[non_exhaustive]
...
pub struct ClientMethodNames {
    ...
    /// Method for opening an MCP-over-agent-transport connection.
    #[cfg(feature = "unstable_mcp_over_agent_transport")]
    pub mcp_connect: &'static str,
    /// Method for exchanging MCP-over-agent-transport messages.
    #[cfg(feature = "unstable_mcp_over_agent_transport")]
    pub mcp_message: &'static str,
    /// Method for closing an MCP-over-agent-transport connection.
    #[cfg(feature = "unstable_mcp_over_agent_transport")]
...
pub enum AgentRequest {
    ...
    ///
    /// See protocol docs: [Client](https://agent-transport-protocol/protocol/overview#client)
    ...
    /// method.
    ///
    /// See protocol docs: [Terminals](https://agent-transport-protocol/protocol/terminals)
    ...
    /// This capability is not part of the spec yet, and may be removed or changed at any point.
    ///
    /// Opens an MCP-over-agent-transport connection.
    #[cfg(feature = "unstable_mcp_over_agent_transport")]
    ...
    /// This capability is not part of the spec yet, and may be removed or changed at any point.
    ///
    /// Closes an MCP-over-agent-transport connection.
    #[cfg(feature = "unstable_mcp_over_agent_transport")]
    DisconnectMcpRequest(DisconnectMcpRequest),
    /// Handles extension method requests from the agent.
    ///
    /// Allows the Agent to send an arbitrary request that is not part of the agent transport spec.
...
pub enum AgentNotification {
    ...
    /// This capability is not part of the spec yet, and may be removed or changed at any point.
    ///
    /// Receives an MCP-over-agent-transport notification.
    #[cfg(feature = "unstable_mcp_over_agent_transport")]
    MessageMcpNotification(MessageMcpNotification),
    /// Handles extension notifications from the agent.
    ///
    /// Allows the Agent to send an arbitrary notification that is not part of the agent transport spec.
...
mod tests {
    ...
    fn test_agent_mcp_request_method_names() {
        ...
        assert_eq!(
            ...
            json!({ "agentTransportId": "server-1" })
        );
        assert_eq!(
