...
Use [llama.cpp](https://llama.app) and its built-in server for local models with Inline Assistant and similar model-backed Zed AI features.
...
Use Ollama for local models with Inline Assistant and similar model-backed Zed AI features.
...
Use LM Studio for local models with Inline Assistant and similar model-backed Zed AI features.
