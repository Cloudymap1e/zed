...
//!
/// See protocol docs: [Tool Calls](https://agent-transport-protocol/protocol/tool-calls)
...
///
/// See protocol docs: [Updating](https://agent-transport-protocol/protocol/tool-calls#updating)
#[skip_serializing_none]
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, JsonSchema)]
#[serde(rename_all = "camelCase")]
#[non_exhaustive]
...
///
/// See protocol docs: [Creating](https://agent-transport-protocol/protocol/tool-calls#creating)
...
///
/// See protocol docs: [Status](https://agent-transport-protocol/protocol/tool-calls#status)
...
///
/// See protocol docs: [Content](https://agent-transport-protocol/protocol/tool-calls#content)
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize, JsonSchema)]
...
pub enum ToolCallContent {
    ...
    ///
    /// See protocol docs: [Terminal](https://agent-transport-protocol/protocol/terminals)
    Terminal(Terminal),
}
...
///
/// See protocol docs: [Following the Agent](https://agent-transport-protocol/protocol/tool-calls#following-the-agent)
#[skip_serializing_none]
