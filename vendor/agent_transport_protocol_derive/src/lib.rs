//! Derive macros for agent transport protocol JSON-RPC traits.
//!
...
//!
//! ```ignore
//! use agent_transport_protocol::{JsonRpcRequest, JsonRpcNotification, JsonRpcResponse};
//!
...
//! ```
//!
//! # Using within the `agent_transport_protocol` crate
//!
//! When using these derives within the `agent_transport_protocol` crate itself, add `crate = crate`:
//!
//! ```ignore
...
/// - `#[request(method = "method_name", response = ResponseType, crate = crate)]` - for use within the `agent_transport_protocol` crate
///
/// # Example
///
/// ```ignore
...
/// - `#[notification(method = "method_name", crate = crate)]` - for use within the `agent_transport_protocol` crate
///
/// # Example
///
/// ```ignore
...
/// # Attributes
///
/// - `#[response(crate = crate)]` - for use within the `agent_transport_protocol` crate
///
/// # Example
///
/// ```ignore
...
fn default_crate_path() -> Path {
    syn::parse_quote!(agent_transport_protocol)
}
