...
//!
//! See: [Agent Plan](https://agent-transport-protocol/protocol/agent-plan)
...
/// See protocol docs: [Plan Entries](https://agent-transport-protocol/protocol/agent-plan#plan-entries)
#[skip_serializing_none]
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema, PartialEq, Eq)]
#[serde(rename_all = "camelCase")]
#[non_exhaustive]
