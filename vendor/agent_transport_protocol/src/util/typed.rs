...
/// # use agent_transport_protocol::util::MatchDispatch;
/// # async fn example(message: Dispatch) -> Result<(), agent_transport_protocol::Error> {
/// MatchDispatch::new(message)
///     .if_request(|req: InitializeRequest, responder: agent_transport_protocol::Responder<InitializeResponse>| async move {
...
///                 responder.respond_with_error(agent_transport_protocol::util::internal_error("unknown method"))
///             }
...
/// ```
/// # use agent_transport_protocol::Dispatch;
/// # use agent_transport_protocol::schema::v1::{AgentCapabilities, InitializeRequest, InitializeResponse, PromptRequest, PromptResponse, StopReason};
/// # use agent_transport_protocol::util::MatchDispatchFrom;
/// # async fn example(message: Dispatch, cx: &agent_transport_protocol::ConnectionTo<agent_transport_protocol::Client>) -> Result<(), agent_transport_protocol::Error> {
...
///     })
///     .await
///     .if_request(|_req: PromptRequest, responder: agent_transport_protocol::Responder<PromptResponse>| async move {
///         // Handle prompts
...
///         match message {
///             Dispatch::Request(_, responder) => responder.respond_with_error(agent_transport_protocol::util::internal_error("unknown method")),
///             Dispatch::Notification(_) | Dispatch::Response(_, _) => Ok(()),
///         }
///     })
///     .await
...
///
/// ```
/// # use agent_transport_protocol::{UntypedMessage, ConnectionTo, Agent};
/// # use agent_transport_protocol::schema::v1::SessionNotification;
/// # use agent_transport_protocol::util::TypeNotification;
/// # async fn example(message: UntypedMessage, cx: &ConnectionTo<Agent>) -> Result<(), agent_transport_protocol::Error> {
