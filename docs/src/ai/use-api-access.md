...
Use API access for Inline Assistant, Git commit generation,
...
Zed can be configured with OpenCode models. Add custom OpenCode models when you need newer models, limited-time Free models, or models with custom endpoints.
